...
Une fois votre compte GutHub ouvert, allez au [Menu principal](https://github.com/) du site où vous pouvez avoir une vision sur tous les Répertoires que vous avez créé ainsi que ceux que vous avez cloné. 
&nbsp;

```{r pic1, echo=FALSE, out.width = '100%', fig.align = "center"}
...
```{r pic2, echo=FALSE, out.width = '100%', fig.align = "center"}
...
```{r pic3, echo=FALSE, out.width = '100%', fig.align = "center"}
knitr::include_graphics("repository.png")
```
&nbsp;

Une fois votre répertoire créé (image ci-dessus), celui-ci est disponible dans votre onglet "Repositories" et vous pouvez le gérer à votre guise.
