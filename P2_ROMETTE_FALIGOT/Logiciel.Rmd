...
GitHub a par conséquent développé un outil simplifiant l'usage de Git : GitHub Desktop *trompettes*

```{r pic4, echo=FALSE, out.width = '30%', fig.align = "center"}
...
Ainsi, ilest possible de voir sur cet exemple des fichiers qui ont été :  
...
Lorsqu'un commit a été effectué, il suffit de cliquer, dans le menu principal, sur le bouton qui s'appelle *`Pull origin`*.  
